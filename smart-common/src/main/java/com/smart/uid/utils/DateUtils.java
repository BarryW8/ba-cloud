...
public abstract class DateUtils extends org.apache.commons.lang.time.DateUtils {
     ...
     * @author yebo
     */
    public static String getCurrentByDateTimePattern() {
        Calendar cal = Calendar.getInstance();
        return formatByDateTimePattern(cal.getTime());
    }
     ...
     * @return
     */
    public static long dateDiff(String beginDate, String endDate) {

        Date date1 = parseDate(beginDate, DATETIME_PATTERN);
        Date date2 = parseDate(endDate, DATETIME_PATTERN);
